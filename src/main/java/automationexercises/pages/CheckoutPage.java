...
public class CheckoutPage {
    ...
    public CheckoutPage verifyDeliveryAddress(String title, String fName, String lName, String company, String address1, String address2,
        ...
        Assertions.assertEquals( (title + ". " + fName + " " + lName),page.locator(deliveryName).innerText()," Delivery Name is not matched");
        Assertions.assertEquals( company,page.locator(deliveryCompany).innerText(),"Delivery Company is not matched");
        Assertions.assertEquals(address1 ,page.locator(deliveryAddress1).innerText()," Delivery Address1 is not matched");
        Assertions.assertEquals( address2,page.locator(deliveryAddress2).innerText()," Delivery Address2 is not matched");
        Assertions.assertEquals( (city + " " + state + " " + zip),page.locator(deliveryCityStateZip).innerText()," Delivery CityStateZip is not matched");
        Assertions.assertEquals( country,page.locator(deliveryCountry).innerText()," Delivery Country is not matched");
        Assertions.assertEquals( phone,page.locator(deliveryPhone).innerText()," Delivery Phone is not matched");
        return this;
    }
    ...
    public CheckoutPage verifyBillingAddress(String title, String fName, String lName, String company, String address1, String address2,
        ...
        Assertions.assertEquals( (title + ". " + fName + " " + lName),page.locator(deliveryName).innerText()," Billing Name is not matched");
        Assertions.assertEquals( company,page.locator(billingCompany).innerText(),"Billing Company is not matched");
        Assertions.assertEquals(address1 ,page.locator(deliveryAddress1).innerText()," Billing Address1 is not matched");
        Assertions.assertEquals( address2,page.locator(billingAddress2).innerText()," Billing Address2 is not matched");
        Assertions.assertEquals( (city + " " + state + " " + zip),page.locator(billingCityStateZip).innerText()," Billing CityStateZip is not matched");
        Assertions.assertEquals( country,page.locator(billingCountry).innerText()," Billing Country is not matched");
